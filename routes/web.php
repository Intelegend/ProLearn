...
Route::get('mark/{course_id}', ['uses' => 'MarkController@show', 'as' => 'mark.show']);

// Mail Routes...
Route::get('mail',['as' => 'sendmail', 'uses' => 'SendMailController@index']);
Route::get('send-mail',['as' => 'send', 'uses' => 'SendMailController@send']);
...
Route::group(['middleware' => ['admin'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::resource('mark', 'Admin\MarkController');
    Route::post('mark_mass_destroy', ['uses' => 'Admin\MarkController@massDestroy', 'as' => 'mark.mass_destroy']);
    Route::post('mark_restore/{id}', ['uses' => 'Admin\MarkController@restore', 'as' => 'mark.restore']);
    Route::delete('mark_perma_del/{id}', ['uses' => 'Admin\MarkController@perma_del', 'as' => 'mark.perma_del']);
