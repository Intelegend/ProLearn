        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('teachers', 'Учителя', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('slug', 'Жетон', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    @endif
                    {!! Form::label('course_image', 'Картинка курса', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('start_date', 'Дата создания курса', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('published', 'Опубликовано', ['class' => 'control-label']) !!}
