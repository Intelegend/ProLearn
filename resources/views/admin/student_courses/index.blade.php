...
@section('content')
    <h3 class="page-title">@lang('global.stud_course.title')</h3>
    @can('course_create')
    ...
    <p>
        <ul class="list-inline">
            <li><a href="{{ route('admin.courses.index') }}" style="{{ request('show_deleted') == 1 ? '' : 'font-weight: 700' }}">Все</a></li> |
            <li><a href="{{ route('admin.courses.index') }}?show_deleted=1" style="{{ request('show_deleted') == 1 ? 'font-weight: 700' : '' }}">Корзина</a></li>
        </ul>
    </p>
            ...
            <table class="table table-bordered table-striped {{ count($courses) > 0 ? 'datatable' : '' }} @can('course_delete') @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                <thead>
                    <tr>
                        ...
                        @endif
                        <th>@lang('global.stud_course.fields.course')</th>
                        <th>@lang('global.stud_course.fields.student')</th>
