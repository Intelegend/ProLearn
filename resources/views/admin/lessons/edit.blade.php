        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    @endif
                    {!! Form::label('lesson_image', 'Картинка урока', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('downloadable_files', 'Загружаемый файл', ['class' => 'control-label']) !!}
                        ...
                        <div class="files-list">
                            @foreach($lesson->getMedia('downloadable_files') as $media)
                                <p class="form-group">
                                    ...
                                    <a href="#" class="btn btn-xs btn-danger remove-file">Удалить</a>
