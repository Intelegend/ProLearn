...
{
    public function show($course_id, $lesson_slug,$test_id,$student_id,$test_result)
    {
    ...
    public function test($lesson_slug, Request $request)
    {
        ...
        return redirect()->route('lessons.show', [$lesson->course_id, $lesson_slug])->with('message', 'Баллы за тест: ' . $test_score);
    }
}
