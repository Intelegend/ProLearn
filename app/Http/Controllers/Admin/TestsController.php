...
class TestsController extends Controller
{
    ...
    public function create()
    {
        ...
        $courses = $courses->pluck('title', 'id')->prepend('Пожалуйста выберите', '');
        $lessons = \App\Lesson::whereIn('course_id', $courses_ids)->get()->pluck('title', 'id')->prepend('Пожалуйста выберите', '');
