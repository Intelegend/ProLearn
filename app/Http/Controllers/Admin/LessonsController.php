...
class LessonsController extends Controller
{
    ...
    public function create()
    {
        ...
        $courses = \App\Course::ofTeacher()->get()->pluck('title', 'id')->prepend('Пожалуйста выберите', '');
    ...
    public function show($id)
    {
        ...
        $courses = \App\Course::get()->pluck('title', 'id')->prepend('Пожалуйста выберите', '');$tests = \App\Test::where('lesson_id', $id)->get();
